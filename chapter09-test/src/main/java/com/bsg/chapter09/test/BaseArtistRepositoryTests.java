package com.bsg.chapter09.test;

import com.bsg5.chapter09.common.BaseArtist;
import com.bsg5.chapter09.common.BaseArtistRepository;
import com.bsg5.chapter09.common.WildcardConverter;
...
public abstract class BaseArtistRepositoryTests<A extends BaseArtist<ID>, ID> extends AbstractTestNGSpringContextTests {
